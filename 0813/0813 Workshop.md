...
```html
![result3](workshop/result3.JPG)<!DOCTYPE html>
<html lang="ko">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<body>
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="item offset-4 offset-md-0 offset-lg-2 col-4 col-lg-8">
        <p>item2</p>
      </div>
    </div>
